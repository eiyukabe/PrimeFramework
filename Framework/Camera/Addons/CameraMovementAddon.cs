...
/// <summary> Attach a node with this script to a Camera2D to let the player move the camera. </summary>
public class CameraMovementAddon : Node
{
    ...
    private Vector2 StartingZoom;       // Used when resetting the camera.
